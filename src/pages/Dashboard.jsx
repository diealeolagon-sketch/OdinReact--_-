  ...
  return (
    <div className="p-6 md:p-8">
      <div style={{ marginBottom: '24px' }}>
        <h2 style={{ fontFamily: 'var(--h2-TITLE-font-family)', fontSize: '24px', fontWeight: 700, color: 'var(--azul-oscuro)' }}>
          Panel de Inicio
        </h2>
        <p style={{ fontFamily: 'var(--paragraph-font-family)', color: 'var(--gris-oscuro-neutro)', fontSize: '14px', margin: '4px 0 0 0' }}>
          Resumen general de la gestión documental de ODIN
        </p>
      </div>
